...
with_node \
  ...
  --target "/Users/tom/tendly/ios/Pods/Target Support Files/Pods-Tendly/ExpoModulesProvider.swift" \
  --entitlement "/Users/tom/tendly/ios/Tendly/Tendly.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
